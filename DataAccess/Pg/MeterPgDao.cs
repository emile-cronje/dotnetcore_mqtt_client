                ...
                for (var retry = 0; retry < maxRetries; retry++)
                {
                    ...
                    try
                    {
                            ...
                            connection, transaction))
                        {
                            ...
                            updateCmd.Parameters.AddWithValue("code", meter.Code ?? (object)DBNull.Value);
                            updateCmd.Parameters.AddWithValue("description", meter.Description ?? (object)DBNull.Value);
